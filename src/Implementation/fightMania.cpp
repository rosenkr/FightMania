...
int main(int argc, char *argv[])
{
	...
	datatypes::Hitbox hb4(datatypes::Point(500, 500), 150, 35, false);

	graphics::Sprite bar(hb4, graphics::Sprite::Layer::UICOMPONENT, str + "resources/images/UIComponents/Bar.png");

	graphics::Sprite s(hb, graphics::Sprite::Layer::UICOMPONENT, str +"resources/images/UIComponents/TextBox.png");
	graphics::Sprite s1(hb1, graphics::Sprite::Layer::UICOMPONENT, str +"resources/images/UIComponents/TextBox.png");
	graphics::Sprite s2(hb2, graphics::Sprite::Layer::UICOMPONENT, str +"resources/images/UIComponents/TextBox.png");
	graphics::Sprite s3(hb3, graphics::Sprite::Layer::UICOMPONENT, str +"resources/images/UIComponents/TextBox.png");
	graphics::Sprite sChecked(hb, graphics::Sprite::Layer::UICOMPONENT, str +"resources/images/UIComponents/FocusedTextbox.png");
	graphics::Sprite sChecked1(hb1, graphics::Sprite::Layer::UICOMPONENT, str +"resources/images/UIComponents/FocusedTextbox.png");
	graphics::Sprite sChecked2(hb2, graphics::Sprite::Layer::UICOMPONENT, str +"resources/images/UIComponents/FocusedTextbox.png");
	graphics::Sprite sChecked3(hb3, graphics::Sprite::Layer::UICOMPONENT, str +"resources/images/UIComponents/FocusedTextbox.png");
	...
	uicomponents::UIComponent *uic = new uicomponents::SlideBar(hb4, bar, 10, 30, str +"resources/images/UIComponents/Slider.png", str + "resources/images/UIComponents/FocusedSlider.png");
